...
?>
    <!-- Edit post modal -->
    <div class="modal fade bd-example-modal-lg" autofocus="false" id="edit-post-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModal3Label" aria-hidden="true">
